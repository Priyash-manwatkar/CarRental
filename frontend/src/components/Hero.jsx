...
//     setPickupDate,
//     returnDate,
//     setReturnDate,navigate}=useAppContext()
...
//        <form  onSubmit={handelSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200
...
//             type='date'
//             id='pickup-date' min={new  Date().toISOString().split('T')[0] } className='text-sm text-gray-500' required/>
//         </div>
...
//             id='return-date' min={new  Date().toISOString().split('T')[0] } className='text-sm text-gray-500' required/>
//         </div>
...
function Hero() {
  ...
  return (
    ...
    transition={{duration:0.8,delay:0.6}}
          src={assets.search_icon} alt='search' />Search
        </motion.button>
      </motion.form>
