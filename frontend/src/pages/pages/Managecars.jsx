...
//       console.log(data);
//       if (data.success) {
//         setCars(data.cars || []); // match backend key
//       } else {
...
//     }
//   };
//   const toogleAvailibilty = async (carId) => {
//     try {
//       const { data } = await axios.post('/api/owner/toogle-car',{carId});
     
//       if (data.success) {
//        toast.success(data.message) 
//        fetchOwner()// match backend key
//       } else {
//         toast.error(data.message);
//       }
//     } catch (error) {
...
//                   <img
//                     src={car.image} // corrected key from img -> image
//                     alt="car image"
...
//                   <span className={`p-3 py-1 rounded-full text-xs ${car.isAvailable ? 'bg-green-100 text-green-500' : 'bg-red-100 text-red-500'}`}>
//                     {car.isAvailable ? "Available" : "Unavailable"}
//                   </span>
//                 </td>
//                 <td className="flex items-center p-3 gap-2">
//                   <img
//                   onClick={()=>toogleAvailibilty(car._id)}
